...
const members = [
  { name: 'Riya Sharma', interest: 'Solo backpacking and cafe trails', image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=500&q=80' },
  { name: 'Aman Verma', interest: 'Bike trips, mountains, and group tours', image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=500&q=80' },
  { name: 'Neha Kapoor', interest: 'International city breaks and food walks', image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=500&q=80' },
]
